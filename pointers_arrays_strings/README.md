# C - Pointers, arrays and strings :skull:
...
This project is about what and how to use pointers and arrays and
...
* **7. Mozart composed his music not for the elite, but for everybody**
  * [7-leet.c](./7-leet.c): C function that encodes a string into [1337](https://en.wikipedia.org/wiki/Leet), without
